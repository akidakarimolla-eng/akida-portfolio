    ...
    <section ref={rootRef} className={clsx(styles.root)}>
      <div className={clsx(styles.topContainer, 'layout-grid-inner')}>
        <div className={styles.leftContainer}>
          <h2 className="h2">A Short Line</h2>
          <h2 className={clsx('h2', 'bold')}>That Says What You Do.</h2>
        </div>
        {!isMobile && (
          <h6 className={clsx('h6', styles.rightContainer)}>
            I&apos;m Your Name, a short description of your work. Two sentences is the right length here. The second one gives a little more context.
          </h6>
        )}
      </div>
